...
Ce projet est un système d'inscription complet développé intégralement dans un environnement Linux. L'objectif était de creer un formulaire sans utiliser d'outils simplifiés (comme Wamp), en configurant manuellement le serveur et la base de données.
